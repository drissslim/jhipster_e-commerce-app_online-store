package info.driss.store.repository;

import info.driss.store.StoreApp;
import info.driss.store.config.Constants;
import info.driss.store.config.audit.AuditEventConverter;
import info.driss.store.domain.PersistentAuditEvent;
...
import static info.driss.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
